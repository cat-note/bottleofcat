...
/*
    ...
    2. 如果两字符串的等长部分无法决定字典序，需要看【较长一个字符串】的多出来的【一个字符】:
        ...
        * 比如135和13，肯定是13513 > 13135

        * 而321和32，那就是32321 > 32132

        * 很容易能发现，只需要将【较长字符串】的后面【多出来的第一个字符】和其【首个字符】进行比较即可，这样才能保证高位数字尽可能大。

            - 比如上面的135就是把5和1相比，发现5>1，那么135要拼接在13前面
            - 再看321，可以发现1和3相比，有1<3，那么321就要拼接在32的后面

        - SomeBottle 2023.2.25
*/
