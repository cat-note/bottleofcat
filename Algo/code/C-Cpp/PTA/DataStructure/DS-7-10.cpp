...
/*
    注意本题重在求【连通】的最小成本，也就是要求一个【最小生成树】的【权】，而不是找最短路径。

    最小生成树算法常见的有Kruskal和Prim，这里我采用了Prim算法。
    * 另外我还写了个Kruskal的实现，不过用的是DFS判断环路，源代码是 DS-7-10-Kruskal-TLE.cpp
    * 2023.1.19更新: 搞清楚并查集后我用并查集重新写了Kruskal: DS-7-10-Kruskal.cpp
