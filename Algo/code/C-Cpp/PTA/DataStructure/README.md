...
|7-29|[修理牧场](https://pintia.cn/problem-sets/15/exam/problems/856)| [DS-7-29.cpp](./DS-7-29.cpp) | 不妨**反着看**切割的过程: 每次由**两个小木块**组成**一块大木头**。采用霍夫曼的贪心算法，在序列中**每次选择最小的两块木板**来组成大木板，大木板的长度就是**单次切割的花费**，选择过程类似于霍夫曼树的构造。这题一定程度上能锻炼算法思维，值得回顾 | 0.5√ |
