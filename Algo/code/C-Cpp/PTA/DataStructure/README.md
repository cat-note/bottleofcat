...
|7-31|[笛卡尔树](https://pintia.cn/problem-sets/15/exam/problems/858)| [DS-7-31.cpp](./DS-7-31.cpp) | 本题考察对**是否是二叉搜索树**和**是否是小根堆**的判断。值得回顾的是对二叉搜索树的判断，因为BST的**中序遍历序列**是呈**升序**的，因此如果一棵二叉树的**中序遍历序列递增**，这棵树就满足二叉搜索树的性质。 | 0.5√ |
